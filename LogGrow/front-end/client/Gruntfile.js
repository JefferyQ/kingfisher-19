(function () {
    ...
    module.exports = function(grunt) {
        ...
        grunt.initConfig({
            ...
            prettify: {
                ...
                all: {
                    ...
                    cwd: '/',
                    ext: '.html',
                    src: ['**/*.html',"!node_modules/**","!*/bower_components/**", "!bower_components/**"],
                    dest: '/'
                }
            },
            htmlmin: {                                     
            ...
            concurrent: {
                ...
                dist: ["compass:dist", "copy:styles", "htmlmin2"],
                lessServer: ["less:server", "copy:styles"],
                lessDist: ["less:dist", "copy:styles", "htmlmin2"]
            },
            concat: {
                css: {
                    src: [
            ...
            uglify: {
                js: {
                    files: {
                        'build/combined.js': ['build/combined.js'],
                        'build/bower-concat.js': ['build/bower-concat.js']
                    }
                }
            },
            bower_concat: {
        ...
        grunt.registerTask("build", ["clean:dist", "useminPrepare", "concurrent:dist", "copy:dist", "cssmin", "concat", "uglify", "usemin","prettify","htmlmin","htmlminify"]);
